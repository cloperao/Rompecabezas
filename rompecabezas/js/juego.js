...
var instrucciones = [];
instrucciones[0] = "Utiliza las flechas para mover las piezas.";
instrucciones[1] = "Ordena las piezas hasta alcanzar la imagen objetivo.";
...
function mostrarCartelGanador() {
    //Uso de Sweet Alert para mostrar la Alerta de Ganador
    Swal.fire('Ganaste!');
}
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
    debugger;
    var temporalDeIntercambio;
    temporalDeIntercambio = grilla[filaPos1][columnaPos1];
    grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
    grilla[filaPos2][columnaPos2] = temporalDeIntercambio;
}
